...
import 'package:loven/features/artist_profile/controller/bloc/artist_profile_bloc.dart';
import 'package:loven/features/artist_profile/controller/bloc/artist_profile_event.dart';
import 'package:loven/features/artist_profile/domain/repositories/artist_repository.dart';
...
class ArtistProfileScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (_) =>
          ArtistProfileBloc(repository: context.read<ArtistRepository>())
